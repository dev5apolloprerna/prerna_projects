<div class="mb-3">
  <div class="alert alert-light border">
    <div class="d-flex justify-content-between flex-wrap">
      ...
      <div class="text-end">
        <div><strong>Base:</strong> ₹{{ number_format($snap['base']) }}</div>
        <div><strong>Extra:</strong> ₹{{ number_format($snap['extra']) }} @if($snap['extra']>0)<small class="text-muted">(+{{ $snap['extra_days'] }} d)</small>@endif</div>
